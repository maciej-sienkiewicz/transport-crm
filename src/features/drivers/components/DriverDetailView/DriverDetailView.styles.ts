// src/features/drivers/components/DriverDetailView/DriverDetailView.styles.ts
...
export const AlertCard = styled.div<{ $severity: 'warning' | 'danger' }>`
    background: ${({ $severity, theme }) =>
    $severity === 'danger' ? theme.colors.danger[50] : theme.colors.warning[50]};
    border: 1px solid ${({ $severity, theme }) =>
    $severity === 'danger' ? theme.colors.danger[200] : theme.colors.warning[200]};
    border-left: 4px solid ${({ $severity, theme }) =>
    $severity === 'danger' ? theme.colors.danger[500] : theme.colors.warning[500]};
    border-radius: ${({ theme }) => theme.borderRadius.xl};
