// src/features/children/components/ActivityHistory/ActivityHistory.tsx
import React, { useState } from 'react';
import { User, Clock, FileText, ArrowRight } from 'lucide-react';
import styled from 'styled-components';
import { useChildActivities } from '../../hooks/useChildActivities';
...
import {
    ...
    getActivityColor
} from "@/features/children/lib/activityUtils.ts";
...
export const ActivityHistory: React.FC<ActivityHistoryProps> = ({ childId }) => {
    ...
    const { data, isLoading, error } = useChildActivities(childId, {
        category,
        page,
        size: 20,
    });
                    ...
                    <Timeline>
                        {activities.map((activity) => {
                            const showRouteButton =
                                activity.type === 'CHILD_ASSIGNED_TO_ROUTE' &&
